...
$(call inherit-product, vendor/xiaomi/klee-miuicamera/klee-miuicamera-vendor.mk)
...
# Public libraries
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/public.libraries-xiaomi.txt:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/public.libraries-xiaomi.txt
